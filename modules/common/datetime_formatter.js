...
(function(window) {
    ...
    function formatDateTime(format, date = new Date()) {
        ...
        const getISO = () => {
            ...
            iso = { weekNumber, isoYear, isoWeekday };
            return iso;
        };
        ...
        const directives = {
            ...
            '%%': () => '%',                                          // Literal '%'
            '%G': () => getISO().isoYear,                             // ISO 8601 week-based year (C89 additional specifier)
            '%u': () => getISO().isoWeekday,                          // ISO 8601 weekday as a number (1=Monday, 7=Sunday) (C89 additional specifier)
            '%V': () => pad(getISO().weekNumber, 2),                  // ISO 8601 week number (01-53) (C89 additional specifier)
